...
namespace VMware.Horizon.Interop
{
    ...
    public interface IVMwareHorizonClientVChanEvents
    {
        ...
        [DispId(2)]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void ConnectEventProc([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint eventType, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UI1), In] Array eventData);
