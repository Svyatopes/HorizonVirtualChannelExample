...
namespace VMware.Horizon.Interop
{
  ...
  public interface IVMwareHorizonClientEvents5 : IVMwareHorizonClientEvents4
  {
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnAuthenticating([In] uint serverId, [In] VmwHorizonClientAuthType authType, [MarshalAs(UnmanagedType.BStr), In] string user);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnReceivedLaunchItems([In] uint serverId, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN), In] Array launchItems);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnSeamlessWindowsModeChanged([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint enabled);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnSeamlessWindowRemoved([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] int windowId);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnUSBInitializeComplete([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnConnectUSBDeviceComplete([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint isConnected);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnUSBDeviceError([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [MarshalAs(UnmanagedType.BStr), In] string errorMessage);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnFolderCanBeShared([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint canShare);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    new void OnCDRForcedByAgent([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint forcedByAgent);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnReceivedLaunchItems2([In] uint serverId, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN), In] Array launchItems);
  }
}