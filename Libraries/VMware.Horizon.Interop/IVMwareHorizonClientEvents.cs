...
namespace VMware.Horizon.Interop
{
  ...
  public interface IVMwareHorizonClientEvents
  {
    ...
    [DispId(6)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnAuthenticating([In] uint serverId, [In] VmwHorizonClientAuthType authType, [MarshalAs(UnmanagedType.BStr), In] string user);
    ...
    [DispId(11)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnReceivedLaunchItems([In] uint serverId, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN), In] Array launchItems);
    ...
    [DispId(13)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnItemLaunchSucceeded([In] uint serverId, [In] VmwHorizonLaunchItemType type, [MarshalAs(UnmanagedType.BStr), In] string launchItemId);
    ...
    [DispId(17)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnSeamlessWindowsModeChanged([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint enabled);
    ...
    [DispId(19)]
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnSeamlessWindowRemoved([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] int windowId);
  }
}