...
namespace VMware.Horizon.Interop
{
  ...
  public interface IVMwareHorizonClientEvents2 : IVMwareHorizonClientEvents
  {
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnConnectUSBDeviceComplete([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [In] uint isConnected);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void OnUSBDeviceError([In] uint serverId, [MarshalAs(UnmanagedType.BStr), In] string sessionToken, [MarshalAs(UnmanagedType.BStr), In] string errorMessage);
