...
namespace VMware.Horizon.Interop
{
  ...
  public class VMwareHorizonClientClass : IVMwareHorizonClient, VMwareHorizonClient
  {
    ...
    public virtual extern void Advise([MarshalAs(UnmanagedType.IDispatch), In] object events, [In] VmwHorizonClientAdviseFlags flags);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void Unadvise();

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void GetServerInfo([MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN)] out Array serverInfo);
