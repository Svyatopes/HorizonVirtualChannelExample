...
namespace VMware.Horizon.Interop
{
  ...
  public interface IVMwareHorizonClient
  {
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void GetServerInfo([MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN)] out Array serverInfo);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void RegisterVirtualChannelConsumer([MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_UNKNOWN), In] Array channels, [MarshalAs(UnmanagedType.IDispatch), In] object eventsObject, [MarshalAs(UnmanagedType.IDispatch)] out object api);
